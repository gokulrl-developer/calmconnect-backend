...
import IPsychListUseCase, { AdminPsychListResponseItem } from "../../interfaces/IPsychListUseCase.js";
...
async execute(dto: ListPsychDTO): Promise<AdminPsychListResponseItem[]> {
