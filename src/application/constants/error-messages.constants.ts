export const ERROR_MESSAGES = {
  ...
  APPLICATION_LIMIT_EXCEEDED:
    "Application limit exceeded. You can only have 3 applications.",
  PENDING_APPLICATION_EXISTS:
    "You cannot apply again because you already have a pending application.",
  ACCEPTED_APPLICATION_EXISTS:
    "You cannot apply again because you already have an accepted application.",
  ...
  GENDER_REQUIRED:
    "Gender is required and should be of types male,female or others",
  ...
  STATUS_REQUIRED:
    "Status is required and should be of types approved or rejected",
  DATE_REQUIRED: "Date is required",
  DATE_INVALID_FORMAT: "Date is in invalid format",
  CONFLICTING_AVAILABILITY_RULE:
    "An availability rule already existing overlaps with the time range",
  ...
  NORMAL_SLOT_FEES_INVALID:
    "Normal slots fees are not given or are in invalid format",
  QUICK_SLOT_FEES_INVALID: "Quick slots fees are in invalid format",
  SLOTS_OPEN_TIME_INVALID:
    "Slots open time is not given or are in invalid format",
  ...
  QUICK_SLOT_UNRELEASED:
    "The quick slot is not released yet for booking.Try after some time.", //////////////
  INVALID_FIELDS:
    "The action cannot be completed .some invalid fields are there in the request",
  CONFLICTING_SPECIAL_DAY:
    "There is an exception overlapping with the provided time range",
  CONFLICTING_QUICK_SLOT:
