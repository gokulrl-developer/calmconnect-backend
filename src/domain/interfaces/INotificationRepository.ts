...
export interface INotificationRepository extends IBaseRepository<Notification> {
  findByRecipient(recipientType:NotificationRecipientType,recipientId: string ,skip?: number, limit?: number): Promise<{notifications:Notification[],totalItemCount:number}>;
